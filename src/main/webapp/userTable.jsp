            ...
            <div class="col-md-9 col-12">
                ...
                <div class="p-3 border rounded">
                    ...
                    <div class="action-bar mb-3">
                        ...
                        <form method="get" action="UsersDisplayServlet" class="search-form">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="UsersAddServlet" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="recordRole" class="form-label fw-semibold">Role</label>
                                            <select class="form-select" id="recordRole" name="role" required>
                                                <option value="" disabled selected>Select role</option>
                                                <option value="Admin">Admin</option>
                                                <option value="Employee">Employee</option>
                                                <option value="Dentist" disabled title="Dentist records can be added in the Dentist Tab">Dentist</option>
                                            </select>
                                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="recordPassword" name="password" required>
                                        </div>
                                        <div class="mb-3">
                    ...
                    <div class="modal fade" id="editRecordModal" tabindex="-1" aria-labelledby="editRecordModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="UsersEditServlet" method="post">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editRecordModalLabel">Search the email you want to edit</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                            <h5 class="modal-title" id="editRecordModalLabel">
                                <i class="fas fa-search me-2"></i>Search User to Edit
                            </h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        ...
                        <form action="UsersEditServlet" method="post">
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="recordEmail" class="form-label fw-semibold">Email Address</label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-light">
                                            <i class="fas fa-envelope text-primary"></i>
                                        </span>
                                        <input type="email" class="form-control" id="recordEmail" name="email" 
                                ...
                                <tr>
                                    <th>
                                        <%
                                            ...
                                            boolean isThisColumnSorted = "user_id".equals(currentSortField);
                                        ...
                                        <form action="UsersDisplayServlet" method="get" style="display: inline;">
                                            ...
                                            <button type="submit" class="sort-button">
                                                User ID <i class="fa <%= caretClass %>" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                    </th>
                                    <th>
                                        <%
                                            ...
                                            isThisColumnSorted = "full_name".equals(currentSortField);
                                        ...
                                        <form action="UsersDisplayServlet" method="get" style="display: inline;">
                                            <input type="hidden" name="sortField" value="full_name">
                                            <input type="hidden" name="sortOrder" value="<%= newSortOrder %>">
                                            <button type="submit" class="sort-button">
                                    ...
                                    <th>
                                        <%
                                            currentSortField = request.getParameter("sortField");
                                            currentSortOrder = request.getParameter("sortOrder");
                                            isThisColumnSorted = "role".equals(currentSortField);
                                            newSortOrder = "asc".equals(currentSortOrder) && isThisColumnSorted ? "desc" : "asc";
                                            caretClass = isThisColumnSorted ? ("asc".equals(currentSortOrder) ? "fa-caret-up" : "fa-caret-down") : "fa-caret-down";
                                        %>

                                        <form action="UsersDisplayServlet" method="get" style="display: inline;">
                                            <input type="hidden" name="sortField" value="role">
                                            <input type="hidden" name="sortOrder" value="<%= newSortOrder %>">
                                            <button type="submit" class="sort-button">
                                    ...
                                    <th>
                                        <%
                                            currentSortField = request.getParameter("sortField");
                                            currentSortOrder = request.getParameter("sortOrder");
                                            isThisColumnSorted = "username".equals(currentSortField);
                                            newSortOrder = "asc".equals(currentSortOrder) && isThisColumnSorted ? "desc" : "asc";
                                            caretClass = isThisColumnSorted ? ("asc".equals(currentSortOrder) ? "fa-caret-up" : "fa-caret-down") : "fa-caret-down";
                                        %>
                                        ...
                                        <form action="UsersDisplayServlet" method="get" style="display: inline;">
                                            ...
                                            <input type="hidden" name="sortOrder" value="<%= newSortOrder %>">
                                            <button type="submit" class="sort-button">
                                                Username <i class="fa <%= caretClass %>" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                    </th>
                                    <th>
                                        <%
                                            currentSortField = request.getParameter("sortField");
                                            currentSortOrder = request.getParameter("sortOrder");
                                            isThisColumnSorted = "password".equals(currentSortField);
                                            newSortOrder = "asc".equals(currentSortOrder) && isThisColumnSorted ? "desc" : "asc";
                                            caretClass = isThisColumnSorted ? ("asc".equals(currentSortOrder) ? "fa-caret-up" : "fa-caret-down") : "fa-caret-down";
                                        %>

                                        <form action="UsersDisplayServlet" method="get" style="display: inline;">
                                            <input type="hidden" name="sortField" value="password">
                                            <input type="hidden" name="sortOrder" value="<%= newSortOrder %>">
                                            <button type="submit" class="sort-button">
                                                Password <i class="fa <%= caretClass %>" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                    </th>
                                    <th>
                                        <%
                                            currentSortField = request.getParameter("sortField");
                                            currentSortOrder = request.getParameter("sortOrder");
                                            isThisColumnSorted = "email".equals(currentSortField);
                                            newSortOrder = "asc".equals(currentSortOrder) && isThisColumnSorted ? "desc" : "asc";
                                            caretClass = isThisColumnSorted ? ("asc".equals(currentSortOrder) ? "fa-caret-up" : "fa-caret-down") : "fa-caret-down";
                                        %>
                                        ...
                                        <form action="UsersDisplayServlet" method="get" style="display: inline;">
                                            ...
                                            <input type="hidden" name="sortOrder" value="<%= newSortOrder %>">
                                            <button type="submit" class="sort-button">
                                                Email <i class="fa <%= caretClass %>" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                    </th>
                                </tr>
    ...
    <script>
        ...
        function checkForAlerts() {
            ...
            if (alertType && alertMessage) {
                ...
                showAlert(alertType, title, alertMessage, 'UsersDisplayServlet');
