  ...
  <body>
    <div class="container mt-4">
        <div class="form-container mx-auto" style="max-width: 800px;">
            <h1 class="mb-4"><i class="fas fa-teeth me-2"></i>Edit Treatment Record</h1>

            <%
              ArrayList<String[]> records = (ArrayList<String[]>) request.getAttribute("records");
              if (records != null && records.size() > 0) {
                  String[] treatment = records.get(0);
            %>

            <form action="TreatmentUpdateServlet" method="post">
                <div class="mb-3">
                    <label for="treatmentIdDisplay" class="form-label">Treatment ID</label>
                    <input type="text" class="form-control" id="treatmentIdDisplay" value="<%= treatment[0]%>" disabled>
                </div>

                <!-- Hidden field to submit the treatment_id -->
                <input type="hidden" name="record_id" id="record_id" value="<%= treatment[0]%>">
              
                <div class="mb-3">
                    <label for="treatmentType" class="form-label">Treatment Type</label>
                    <input type="text" class="form-control" name="type" id="treatmentType" value="<%= treatment[3] %>">
                </div>

                <div class="mb-3">
                    <label for="treatmentDetails" class="form-label">Treatment Details</label>
                    <input type="text" class="form-control" name="details" id="treatmentDetails" value="<%= treatment[4] %>">
                </div>
                
                <div class="mb-3">
                    <label for="treatmentDate" class="form-label">Treatment Date</label>
                    <input type="datetime-local" class="form-control" name="date" id="treatmentDate" value="<%= treatment[5] %>">
                </div>

                <div class="d-flex justify-content-end mt-4">
                    <a href="TreatmentDisplayServlet" class="btn btn-secondary me-2">Cancel</a>
            ...
            %>
            <div class="alert alert-warning">No treatment data found.</div>
            <%
              }
            %>
        </div>
