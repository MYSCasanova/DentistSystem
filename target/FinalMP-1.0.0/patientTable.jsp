            ...
            <div class="col-md-9 col-12">
                ...
                <div class="p-3 border rounded">
                    ...
                    <div class="action-bar mb-3">
                        ...
                        <form method="get" action="PatientDisplayServlet" class="search-form">
                    ...
                    <div class="modal fade" id="addRecordModal" tabindex="-1" aria-labelledby="addRecordModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="PatientAddServlet" method="post">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label for="recordPatientName" class="form-label fw-semibold">Patient Name</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-light">
                                                    <i class="fas fa-user text-primary"></i>
                                                </span>
                                                <input type="text" class="form-control" id="recordPatientName" name="patient_name" required>
                                            </div>
                                        </div>

                                        <div class="mb-3">
                                            <label for="recordBirthday" class="form-label fw-semibold">Date of Birth</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-light">
                                                    <i class="fas fa-calendar text-primary"></i>
                                                </span>
                                                <input type="date" class="form-control" id="recordBirthday" name="date_of_birth" required>
                                            </div>
                                        </div>

                                        <div class="mb-3">
                                            <label for="recordGender" class="form-label fw-semibold">Gender</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-light">
                                                    <i class="fas fa-venus-mars text-primary"></i>
                                                </span>
                                                <select class="form-select" id="recordGender" name="gender" required>
                                        ...
                                        <div class="mb-3">
                                            <label for="recordAddress" class="form-label fw-semibold">Address</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-light">
                                                    <i class="fas fa-home text-primary"></i>
                                                </span>
                                                <input type="text" class="form-control" id="recordAddress" name="address" required>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-dialog">
                            <form action="PatientAddServlet" method="post">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label for="recordPatientName" class="form-label">Patient Name</label>
                                            <input type="text" class="form-control" id="recordPatientName" name="patient_name" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="recordGender" class="form-label">Gender</label>
                                            <input type="text" class="form-control" id="recordGender" name="gender" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="recordAddress" class="form-label">Address</label>
                                            <input type="text" class="form-control" id="recordAddress" name="address" required>
                                        </div>
                                    </div>
                    ...
                    <div class="modal fade" id="editRecordModal" tabindex="-1" aria-labelledby="editRecordModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="PatientEditServlet" method="post">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editRecordModalLabel">Search the patient ID you want to edit</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header bg-primary text-white">
                                    <h5 class="modal-title" id="editRecordModalLabel">
                                        <i class="fas fa-search me-2"></i>Search Patient to Edit
                                    </h5>
                                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="patientId" name="patient_id" 
                                                       placeholder="Enter patient's ID" required
                                                       pattern="[0-9]+">
                                            </div>
                                            <div class="form-text text-muted">
                                                Enter the ID of the patient you want to edit
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tr>
                                    <th>
                                        <%
                                            ...
                                            boolean isThisColumnSorted = "patient_id".equals(currentSortField);
                                        ...
                                        <form action="PatientDisplayServlet" method="get" style="display: inline;">
                                            <input type="hidden" name="sortField" value="patient_id">
                                            <input type="hidden" name="sortOrder" value="<%= newSortOrder %>">
                                            <button type="submit" class="sort-button">
                                                Patient ID <i class="fa <%= caretClass %>" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                    </th>
                                    <th>
                                        <%
                                            ...
                                            isThisColumnSorted = "patient_name".equals(currentSortField);
                                        ...
                                        <form action="PatientDisplayServlet" method="get" style="display: inline;">
                                            <input type="hidden" name="sortField" value="patient_name">
                                            <input type="hidden" name="sortOrder" value="<%= newSortOrder %>">
                                            <button type="submit" class="sort-button">
                                    ...
                                    <th>
                                        <%
                                            currentSortField = request.getParameter("sortField");
                                            currentSortOrder = request.getParameter("sortOrder");
                                            isThisColumnSorted = "date_of_birth".equals(currentSortField);
                                            newSortOrder = "asc".equals(currentSortOrder) && isThisColumnSorted ? "desc" : "asc";
                                            caretClass = isThisColumnSorted ? ("asc".equals(currentSortOrder) ? "fa-caret-up" : "fa-caret-down") : "fa-caret-down";
                                        %>

                                        <form action="PatientDisplayServlet" method="get" style="display: inline;">
                                            <input type="hidden" name="sortField" value="date_of_birth">
                                            <input type="hidden" name="sortOrder" value="<%= newSortOrder %>">
                                            <button type="submit" class="sort-button">
                                                Date of Birth <i class="fa <%= caretClass %>" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                    </th>
                                    <th>
                                        <%
                                            currentSortField = request.getParameter("sortField");
                                            currentSortOrder = request.getParameter("sortOrder");
                                            isThisColumnSorted = "gender".equals(currentSortField);
                                            newSortOrder = "asc".equals(currentSortOrder) && isThisColumnSorted ? "desc" : "asc";
                                            caretClass = isThisColumnSorted ? ("asc".equals(currentSortOrder) ? "fa-caret-up" : "fa-caret-down") : "fa-caret-down";
                                        %>
                                        ...
                                        <form action="PatientDisplayServlet" method="get" style="display: inline;">
                                            ...
                                            <input type="hidden" name="sortOrder" value="<%= newSortOrder %>">
                                            <button type="submit" class="sort-button">
                                                Gender <i class="fa <%= caretClass %>" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                    </th>
                                    <th>
                                    ...
                                    <th>
                                        <%
                                            currentSortField = request.getParameter("sortField");
                                            currentSortOrder = request.getParameter("sortOrder");
                                            isThisColumnSorted = "address".equals(currentSortField);
                                            newSortOrder = "asc".equals(currentSortOrder) && isThisColumnSorted ? "desc" : "asc";
                                            caretClass = isThisColumnSorted ? ("asc".equals(currentSortOrder) ? "fa-caret-up" : "fa-caret-down") : "fa-caret-down";
                                        %>
                                        ...
                                        <form action="PatientDisplayServlet" method="get" style="display: inline;">
                                            ...
                                            <input type="hidden" name="sortOrder" value="<%= newSortOrder %>">
                                            <button type="submit" class="sort-button">
                                                Address <i class="fa <%= caretClass %>" aria-hidden="true"></i>
                                            </button>
                                        </form>
                                    </th>
                                </tr>
